from burak_folder.lesson_23.locators.main_page_locators import CURR_INFO, IN_SEARCH_FIELD, IFRAME, LI_SEARCH_RESULT
from burak_folder.lesson_23.pages.base_page import BasePage

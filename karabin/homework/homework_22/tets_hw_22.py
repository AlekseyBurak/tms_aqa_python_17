...
#     driver.find_element(By.XPATH, '//*[@id="submit-id-submit"]').click()
#     assert driver.find_element(By.XPATH, '//*[@id="result-text"]').text == 'one'
#     time.sleep(3)
#
#
...
#     driver.find_element(By.XPATH, '//*[@id="submit-id-submit"]').click()
#     assert driver.find_element(By.XPATH, '//*[@id="result-text"]').text == 'Python'
...
#     driver.find_element(By.XPATH, '//*[@id="submit-id-submit"]').click()
#     assert driver.find_element(By.XPATH, '//*[@id="result-text"]').text == 'to go by train to the sea next week'
...
#     driver.find_element(By.XPATH, '//*[@id="submit-id-submit"]').click()
#     assert driver.find_element(By.XPATH, '//*[@class="result-chapters"]').text == 'I did it'
...
#     driver.find_element(By.XPATH, '//*[@id="submit-id-submit"]').click()
#     assert driver.find_element(By.XPATH, '//*[@class="result-chapters"]').text == 'I\nLike to\nTest'
#
#

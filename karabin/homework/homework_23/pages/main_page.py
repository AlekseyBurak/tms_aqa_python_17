...
from karabin.homework.homework_23.locators.main_page_locators import CURR_INFO, IN_SEARCH_FIELD, IFRAME, \
    LI_SEARCH_RESULT, OF_COUNT, SORT_OFFERS, SORTING_OFFERS, LOWEST_PRiCE, GO_TO_CART
from karabin.homework.homework_23.pages.base_page import BasePage
